...
import FollowProfileButton from "../../components/profile/FollowProfileButton";
...
const ProfilePage = ({ initialProfile }: any) => {
...
ProfilePage.getInitialProps = async ({ query: { pid } }: any) => {
